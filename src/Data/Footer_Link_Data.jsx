export default {
  connect: [
    {
      link: "https://github.com/bimannandib",
      icon: (
        <svg
    ...
    {
      link: "https://www.linkedin.com/in/biman-nandi-bn/",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
    ...
    {
      link: "mailto:bimannandib@gmai.com",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
  ...
  copy: "© 2026 Biman Nandi. All Rights Reserved.",
  copyDesc: "Built with React ⚛️",
  topGoIcon: (
    <svg
      width="100%"
      height="100%"
